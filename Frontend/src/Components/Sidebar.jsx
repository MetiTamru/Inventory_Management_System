...
import { faAngleLeft, faAngleRight, faAnglesLeft, faSearch } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    ...
    <Nav className='flex flex-col'>
        <NavIcon className=''>
           <div className='flex '>
            <div>
            <p className='font-bold'> Sell<span className='logo'>Wise</span></p>
      ...
      <SidebarNav isOpen={isOpen} className="flex flex-col h-full overflow-hidden">
          {/* Profile Section */}
