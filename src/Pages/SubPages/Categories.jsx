          ...
          <table className="min-w-full bg-white border border-gray-200 rounded-md">
            <thead className="bg-gray-100">
              <tr>
                ...
                <th className="py-3 px-4 border-b border-gray-200 text-left text-sm font-semibold">Subcategories</th>
              ...
              {categories.map(category => {
                ...
                return (
                  <tr key={category.id} className="hover:bg-gray-50">
                    ...
                    <td className="py-3 px-4 border-b border-gray-200 text-left text-sm">{category.name}</td>
                    ...
                    <td className="py-3 px-4 border-b border-gray-200  text-sm">
                      <div className="flex space-x-2">
                        <Link to={`/manage-items/edit-categories/${category.id}`}>
